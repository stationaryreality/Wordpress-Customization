...
<div class="post-navigation-container reference-nav" style="display: flex; justify-content: space-between; gap: 20px; margin-top: 40px;">
  <?php if ($next_id): ?>
    <div class="previous-post">
      <h2>Next Reference</h2>
      <div class="post-thumbnail reference-nav-thumb">
