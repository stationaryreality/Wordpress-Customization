<?php
/* Template Name: Narrative Threads Page */
...
<main class="homepage-posts">
  ...
  <?php
  // Pages Grid - Optional Secondary Section
  ...
  $page_args = array(
    ...
    'post_status' => 'publish',
    'posts_per_page' => -1,
    'post__not_in' => array_merge(array(get_the_ID()), $excluded_ids), // exclude current and unwanted pages
    'orderby' => 'menu_order',
    'order' => 'ASC'
  );
